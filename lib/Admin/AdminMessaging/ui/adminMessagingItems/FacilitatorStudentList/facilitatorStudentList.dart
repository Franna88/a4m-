...
class FacilitatorStudentList extends StatefulWidget {
  final Function(String id, String name, String userType)? onStudentSelected;
  final String? currentUserId;

  const FacilitatorStudentList({
    super.key,
  ...
  @override
  State<FacilitatorStudentList> createState() => _FacilitatorStudentListState();
}

class _FacilitatorStudentListState extends State<FacilitatorStudentList> {
          ...
          Expanded(
            child: StreamBuilder<DocumentSnapshot>(
              stream: FirebaseFirestore.instance
                  ...
                  .snapshots(),
              builder: (context, facilitatorSnapshot) {
                if (facilitatorSnapshot.connectionState ==
                    ConnectionState.waiting) {
                  return const Center(child: CircularProgressIndicator());
                }

                if (facilitatorSnapshot.hasError) {
                  return Center(
                    child:
                        Text('Error: ${facilitatorSnapshot.error.toString()}'),
                  );
                }

                if (!facilitatorSnapshot.hasData ||
                    !facilitatorSnapshot.data!.exists) {
                  return const Center(
                      child: Text('Facilitator data not found'));
                }
                            ...
                            child: LayoutGrid(
                              ...
                              children: students.map((student) {
                                ...
                                if (student['enrolledCourses'] != null) {
                                  ...
                                  } else if (student['enrolledCourses']
                                      is Map) {
                                    courses = List<String>.from(
