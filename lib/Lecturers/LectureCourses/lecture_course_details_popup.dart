...
class LectureCourseDetailsPopup extends StatefulWidget {
  const LectureCourseDetailsPopup({super.key});

  @override
  State<LectureCourseDetailsPopup> createState() =>
      _LectureCourseDetailsPopupState();
}

class _LectureCourseDetailsPopupState extends State<LectureCourseDetailsPopup> {
  @override
