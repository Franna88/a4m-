...
class StudentCourseDetailsPopup extends StatefulWidget {
  const StudentCourseDetailsPopup({super.key});

  @override
  State<StudentCourseDetailsPopup> createState() =>
      _StudentCourseDetailsPopupState();
}

class _StudentCourseDetailsPopupState extends State<StudentCourseDetailsPopup> {
  @override
